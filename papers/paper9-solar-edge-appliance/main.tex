...
% Power arrows (chain: Solar -> Battery -> Inverter)
\draw[arr] (pv) -- (bess);
\draw[arr] (bess) -- (inv);
% Power distribution (route below servers)
\draw[arr, orange!70!black] (inv.north) -- ++(0,0.5) -- (srv2.south -| inv.north) -- (srv2.south);
\draw[arr, orange!70!black] (inv.north) -- ++(0,0.5) -- (srv1.south -| inv.north) -- (srv1.south);
