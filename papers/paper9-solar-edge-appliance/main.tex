...
% Power arrows
\draw[arr] (pv) -- (inv); \draw[arr] (bess) -- (inv);
\draw[arr, orange!70!black] (inv) -- ++(0,0.65) -| (srv1.south);
\draw[arr, orange!70!black] (inv) -- ++(0,0.65) -| (srv2.south);
...
\node[font=\tiny, text=black!50, rotate=30] at (axis cs:500,70) {6.2-mo payback};
\end{axis}
\end{tikzpicture}
