...
% Power chain: Solar -> Battery -> Inverter (using absolute coords)
\draw[-{Stealth[length=2mm]}, line width=0.6pt, black] (1.15,0) -- (1.65,0);
\draw[-{Stealth[length=2mm]}, line width=0.6pt, black] (3.95,0) -- (4.45,0);
% Power distribution: horizontal bus at y=0.7, then vertical stubs up to servers
\draw[orange!70!black, line width=0.6pt] (5.6,0.38) -- (5.6,0.7);
\draw[orange!70!black, line width=0.6pt] (5.6,0.7) -- (0.5,0.7);
\draw[-{Stealth[length=2mm]}, orange!70!black, line width=0.6pt] (0.5,0.7) -- (0.5,1.12);
\draw[-{Stealth[length=2mm]}, orange!70!black, line width=0.6pt] (4,0.7) -- (4,1.12);
