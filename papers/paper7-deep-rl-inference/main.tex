...
\begin{equation}
\text{prune}(n) {=} \begin{cases} 1 & V_\pi(n) < \tau_{\text{prune}} \\ 0 & \text{otherwise} \end{cases}
\end{equation}
...
\begin{equation}
\text{pri}(r) = w_1 \text{SLO}(r) + w_2 \text{rev}(r) + w_3 / \text{wait}(r)
\end{equation}
...
\textbf{Reward}:
\begin{equation}
r^{m}_t = \alpha\,\text{util\_bal} - \beta\,\text{energy} - \gamma\,\text{therm\_viol}
\end{equation}
...
\begin{equation}
\text{score}(g,w) = \alpha\,\text{cfit}(g,w) - \beta\,\text{trisk}(g) - \gamma\,\text{mcost}(g,w)
\end{equation}
...
\textbf{Reward}:
\begin{equation}
r^{M}_t = -\alpha\,\text{cost} - \beta\,\text{SLO\_viol} - \gamma\,\text{CO}_2 + \delta\,\text{avail}
\end{equation}
...
\begin{equation}
\text{bid}(p,t) = \alpha\,\text{spot}(p,t) + (1{-}\alpha)\,\text{od}(p)\,\text{urg}(t)
\end{equation}
...
\begin{equation}
\mathcal{V} = \textstyle\sum_{\ell \in \{\mu,m,M\}} \alpha_\ell \|Q^\ell_\pi - T^\ell Q^\ell_\pi\|^2
\end{equation}
