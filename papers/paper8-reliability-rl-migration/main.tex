...
\begin{tikzpicture}[
    ...
    arr/.style={-{Stealth[length=1.2mm]}, line width=0.3pt, black!50},
]
% Layers stacked
...
\draw[darr] (t3.south west) -- ++(0,-0.4) -| ([xshift=-3pt]t1a.north);
\draw[darr] (t3.south east) -- ++(0,-0.4) -| ([xshift=3pt]t1b.north);
...
\begin{tikzpicture}[
    ...
    arr/.style={-{Stealth[length=1.5mm]}, line width=0.5pt, black},
